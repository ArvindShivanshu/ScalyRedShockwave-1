...
bot_token = "6726931691:AAERfLfC6V1JST5fllvzbm-LK6wripLnsJI" # Telegram bot token
...
min_with = 1
required_channels = ["@KaranCoder", "@KaranCoder", "@KaranCoder", "@KaranCoder"]
payment_channel = '5337150824'
...
def send_join_message(message):
    ...
    if not h:
        ...
        join_markup.row(
            types.InlineKeyboardButton(text="Join", url="https://t.me/OkWinAppPrediction")
        )
